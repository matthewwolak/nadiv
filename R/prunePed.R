...
#' @usage prunePed(pedigree, phenotyped, \dots{})
#' \method{prunePeddefault}(pedigree, phenotyped, \dots{})
#' \method{prunePednumPed}(pedigree, phenotyped, \dots{})
...
#' Sire), where the ID column cotains an ID for all individuals who are
#' actually phenotyped or are an ancestor to an individual with a phenotype
#' (and are thus informative for estimating parameters in the base population).
