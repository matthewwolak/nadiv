...
#' @return \item{AIC }{vector containing AIC/AICc (depending on value of
#' \code{n}} \item{delta_AIC }{vector containing AIC differences from the
#' minimum AIC(c)} \item{AIClik }{vector containing likelihoods for each model,
#' given the data.  Represents the relative strength of evidence for each
#' model.} \item{w }{Akaike weights.}
